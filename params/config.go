...
var (
	...
	XpansionGenesisHash   = common.HexToHash("0xfb94b16474471ea934ac1b025d4f2fd4d5fa69eb31a7e289c416dbd8eaa26195")
)
...
var (
	...
	XpansionConfig = readChainSpec("chainspecs/xpansion.json")
...
func ChainConfigByGenesisHash(genesisHash common.Hash) *ChainConfig {
	...
	case genesisHash == GnosisGenesisHash:
		return GnosisChainConfig
	case genesisHash == XpansionGenesisHash:
		return XpansionConfig
	default:
		return nil
	}
